...
<html>
	...
	<%
		...
		JSAnalysisData analysisData = jsOptimizer.getAnalysisData(new String[] {"app/stream"});
		String url = request.getContextPath() +"/_javascript?modules=app/stream&version="+analysisData.getChecksum()+"&locale="+request.getLocale();
	%>
	<script type="text/javascript" src="<%=url%>"></script>
	<script type="text/javascript" src="main-stream.js"></script>
    </head>
